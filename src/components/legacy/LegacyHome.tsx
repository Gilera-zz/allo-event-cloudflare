// Den gamla startsidan (före ombyggnaden 2026-09-25), bevarad som komponent utan route.
// Bemanningsdialogen, tjänstekorten, processen, BuilderPreview och texterna här
// återanvänds på /eventproduktion och /bemanning i nästa steg. Rör inte i onödan.
...
export function SectionHeading({ eyebrow, title, dark, centered = false }: { eyebrow: string; title: string; dark: boolean; centered?: boolean }) {
  return (
...
export function ServiceCard({ icon: Icon, title, description, href, external, onClick, bookingIntent }: { icon: typeof Users; title: string; description: string; href?: string; external?: boolean; onClick?: () => void; bookingIntent?: "staffing" | "quote" }) {
  const content = (
    <>
...
export function ProcessStep({ number, icon: Icon, title, body }: { number: string; icon: typeof Users; title: string; body: string }) {
  return (
...
export function ProofItem({ icon: Icon, title, body }: { icon: typeof Users; title: string; body: string }) {
  return (
...
export function PersonCard({ name, role, email, phone }: { name: string; role: string; email: string; phone: string }) {
  return (
...
export function HeroProof({ icon: Icon, title, body }: { icon: typeof Users; title: string; body: string }) {
  return (
